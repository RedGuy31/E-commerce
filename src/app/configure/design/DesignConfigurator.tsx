    ...
    <div className=" relative mt-20 grid  grid-col-1 lg:grid-cols-3 mb-20 pb-20">
      ...
      >
        <div className=" relative w-60 bg-opacity-50 pointer-events-none aspect-[896/1831]">
          ...
          <div
            className={cn(
              "absolute inset-0 left-[3ox] top-px right-[3px] bottom-px rounded-[32px]",
              `  bg-${options.color.tw}`
            )}
          />
        </div>
                    ...
                    <DropdownMenuContent>
                      {MODELS.options.map((model) => (
                        <DropdownMenuItem
                          ...
                          key={model.label}
                          className={cn(
                            "flex text-sm gap-1 items-center p-1.5 hover:bg-zinc-100",
                            {
                              "bg-zinc-100":
                      ...
                      <div className=" mt-3 space-y-4">
                        {selectableOptions.map((option) => (
                          ...
                          >
                            ...
                            <RadioGroup.Description
                              as="span"
                              className=" mt-2 text-sm sm:ml-4 sm:mt-0 sm:flex-col sm:text-right"
                            >
